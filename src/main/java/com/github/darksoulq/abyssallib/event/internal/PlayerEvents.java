...
public class PlayerEvents {
    ...
    public void onPick(PlayerPickBlockEvent event) {
        if (com.github.darksoulq.abyssallib.block.Block.from(event.getBlock()) != null) {
            event.setCancelled(true);
            Item item = com.github.darksoulq.abyssallib.block.Block.asItem(com.github.darksoulq.abyssallib.block.Block.from(event.getBlock()));
            if (item == null) return;
