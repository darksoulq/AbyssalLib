...
public class UpwardBranchingTrunkPlacer extends TrunkPlacer {
     ...
     */
    public static final Codec<UpwardBranchingTrunkPlacer> CODEC = RecordBuilder.create(instance -> instance.group(
        Codecs.INT.fieldOf("branch_count").forGetter(UpwardBranchingTrunkPlacer.class, p -> p.branchCount),
        Codecs.INT.fieldOf("branch_length").forGetter(UpwardBranchingTrunkPlacer.class, p -> p.branchLength)
    ).apply(instance, UpwardBranchingTrunkPlacer::new)).describe("UpwardBranchingTrunkPlacer");
