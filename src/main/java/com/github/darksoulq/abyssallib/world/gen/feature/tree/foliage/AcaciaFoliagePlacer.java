...
public class AcaciaFoliagePlacer extends FoliagePlacer {
     ...
     */
    public static final Codec<AcaciaFoliagePlacer> CODEC = RecordBuilder.create(instance -> instance.group(
        Codecs.INT.fieldOf("radius").forGetter(AcaciaFoliagePlacer.class, p -> p.radius)
    ).apply(instance, AcaciaFoliagePlacer::new)).describe("AcaciaFoliagePlacer");
