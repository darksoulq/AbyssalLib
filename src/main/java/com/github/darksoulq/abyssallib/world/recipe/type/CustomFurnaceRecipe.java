...
public class CustomFurnaceRecipe implements CustomRecipe, BukkitRecipeProvider {
    public static final RecipeType<CustomFurnaceRecipe> TYPE = () -> Codecs.FURNACE_RECIPE;
    ...
    public CustomFurnaceRecipe(NamespacedKey id, RecipeChoice input, ItemStack result, int cookingTime, float exp, Optional<String> group, Optional<CookingBookCategory> category, boolean replace) {
        this.id = id;
        this.input = input;
        this.result = result;
    ...
    public Recipe toBukkit() {
        FurnaceRecipe recipe = new FurnaceRecipe(id, result, input, exp, cookingTime);
