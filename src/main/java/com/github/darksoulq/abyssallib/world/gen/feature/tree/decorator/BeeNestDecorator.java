...
public class BeeNestDecorator extends TreeDecorator {
     ...
     */
    public static final Codec<BeeNestDecorator> CODEC = new Codec<>() {
         ...
         */
        @Override
        public <D> BeeNestDecorator decode(DynamicOps<D> ops, D input) throws CodecException {
            Map<D, D> map = ops.getMap(input).orElseThrow(() -> new CodecException("Expected map"));
            float probability = Codecs.FLOAT.decode(ops, map.get(ops.createString("probability")));
            return new BeeNestDecorator(probability);
        }
         ...
         */
        @Override
        public <D> D encode(DynamicOps<D> ops, BeeNestDecorator value) throws CodecException {
