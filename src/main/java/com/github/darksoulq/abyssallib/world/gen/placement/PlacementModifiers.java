...
public class PlacementModifiers {
    ...
    public static final PlacementModifierType<?> RARITY_FILTER = PLACEMENT_MODIFIERS.register("rarity", id -> RarityFilter.TYPE);
    public static final PlacementModifierType<?> BIOME_FILTER = PLACEMENT_MODIFIERS.register("biome", id -> BiomeFilterModifier.TYPE);
    public static final PlacementModifierType<?> HEIGHTMAP = PLACEMENT_MODIFIERS.register("heightmap", id -> HeightmapModifier.TYPE);
    public static final PlacementModifierType<?> COUNT_MULTILAYER = PLACEMENT_MODIFIERS.register("count_multilayer", id -> CountMultilayerModifier.TYPE);
    public static final PlacementModifierType<?> SURFACE_WATER_DEPTH = PLACEMENT_MODIFIERS.register("surface_water_depth", id -> SurfaceWaterDepthFilter.TYPE);
}
