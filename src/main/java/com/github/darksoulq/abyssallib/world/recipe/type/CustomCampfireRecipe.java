...
public class CustomCampfireRecipe implements CustomRecipe, BukkitRecipeProvider {
    public static final RecipeType<CustomCampfireRecipe> TYPE = () -> Codecs.CAMPFIRE_RECIPE;
    ...
    public CustomCampfireRecipe(NamespacedKey id, RecipeChoice input, ItemStack result, int cookingTime, float exp, Optional<String> group, Optional<CookingBookCategory> category, boolean replace) {
        this.id = id;
        this.input = input;
        this.result = result;
    ...
    public Recipe toBukkit() {
        CampfireRecipe recipe = new CampfireRecipe(id, result, input, exp, cookingTime);
