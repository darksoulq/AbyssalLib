...
public class ItemCategories {
    ...
    public static final ItemCategory ITEMS = ITEM_CATEGORIES.register("items", id -> ItemCategory.builder(id)
        .icon(Blocks.STRUCTURE_BLOCK.getItem().get().clone())
        .add(Blocks.STRUCTURE_BLOCK.getItem().get())
        .build());

    public static final ItemCategory GUI_ITEMS = ITEM_CATEGORIES.register("gui_items", id -> ItemCategory.builder(id)
