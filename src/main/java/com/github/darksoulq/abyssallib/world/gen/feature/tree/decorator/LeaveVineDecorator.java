...
public class LeaveVineDecorator extends TreeDecorator {
     ...
     */
    public static final Codec<LeaveVineDecorator> CODEC = RecordBuilder.create(instance -> instance.group(
        Codecs.FLOAT.fieldOf("probability").forGetter(LeaveVineDecorator.class, p -> p.probability)
    ).apply(instance, LeaveVineDecorator::new)).describe("LeaveVineDecorator");
