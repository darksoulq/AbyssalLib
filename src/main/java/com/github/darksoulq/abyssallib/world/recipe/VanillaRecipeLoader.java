...
public class VanillaRecipeLoader {
    ...
    public static void reload() {
        Registries.SHAPED_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.SHAPELESS_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.TRANSMUTE_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.FURNACE_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.BLASTING_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.SMOKING_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.CAMPFIRE_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.STONECUTTING_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
        Registries.SMITHING_TRANSFORM_RECIPES.getAll().values().forEach(v
                -> Bukkit.addRecipe(v, true));
