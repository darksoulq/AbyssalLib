...
public class TagTypes {
    ...
    public static final TagType<?, ?> ITEM = TAG_TYPES.register("item", ignored -> ItemTag.TYPE);
    public static final TagType<?, ?> BLOCK = TAG_TYPES.register("block", ignored -> BlockTag.TYPE);
}