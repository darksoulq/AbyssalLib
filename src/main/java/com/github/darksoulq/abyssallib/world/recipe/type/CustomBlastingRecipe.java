...
public class CustomBlastingRecipe implements CustomRecipe, BukkitRecipeProvider {
    public static final RecipeType<CustomBlastingRecipe> TYPE = () -> Codecs.BLASTING_RECIPE;
    ...
    public CustomBlastingRecipe(NamespacedKey id, RecipeChoice input, ItemStack result, int cookingTime, float exp, Optional<String> group, Optional<CookingBookCategory> category, boolean replace) {
        this.id = id;
        this.input = input;
        this.result = result;
    ...
    public Recipe toBukkit() {
        BlastingRecipe recipe = new BlastingRecipe(id, result, input, exp, cookingTime);
