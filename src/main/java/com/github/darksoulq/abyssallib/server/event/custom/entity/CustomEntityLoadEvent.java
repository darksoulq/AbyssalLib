...
/**
 * Custom event triggered when a custom {@link CustomEntity} is loaded into the world.
 * <p>
 * This event is fired after the entity has been deserialized and registered.
 * </p>
 */
public class CustomEntityLoadEvent extends Event {
     ...
     */
    public CustomEntityLoadEvent(@NotNull CustomEntity<? extends LivingEntity> entity) {
        this.entity = entity;
    }
     ...
     */
    public @NotNull CustomEntity<? extends LivingEntity> getEntity() {
        return entity;
    }
