...
public abstract class AbstractStringPlaceholder extends Placeholder<String> implements Expressionable<String> {
    ...
    @Override
    public PlaceholderResult<String> sub(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> mul(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> div(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> mod(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> pow(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> min(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> max(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> sin(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> cos(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> tan(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> asin(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> acos(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> atan(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> round(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> floor(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> ceil(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<String> abs(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }
