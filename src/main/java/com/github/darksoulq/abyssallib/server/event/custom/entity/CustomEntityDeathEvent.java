...
/**
 * Custom event triggered when an {@link CustomEntity} dies.
 * <p>
 * This event is {@link Cancellable}, allowing plugins to prevent entity death behavior.
 * </p>
 */
public class CustomEntityDeathEvent extends Event implements Cancellable {
     ...
     */
    public CustomEntityDeathEvent(@NotNull CustomEntity<? extends LivingEntity> entity,
