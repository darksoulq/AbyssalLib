...
public abstract class AbstractBooleanPlaceholder extends Placeholder<Boolean> implements Expressionable<Boolean> {
    ...
    @Override
    public PlaceholderResult<Boolean> add(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> sub(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> mul(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> div(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> mod(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> pow(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> min(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> max(PlaceholderContext ctx, PlaceholderArgument other) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> sin(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> cos(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> tan(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> asin(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> acos(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> atan(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> round(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> floor(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> ceil(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }

    @Override
    public PlaceholderResult<Boolean> abs(PlaceholderContext ctx) {
        return PlaceholderResult.empty();
    }
