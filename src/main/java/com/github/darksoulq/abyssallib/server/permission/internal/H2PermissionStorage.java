...
import com.github.darksoulq.abyssallib.common.database.relational.h2.BatchQuery;
import com.github.darksoulq.abyssallib.common.database.relational.h2.Database;
...
public class H2PermissionStorage implements PermissionStorage {
    private final Database db;

    public H2PermissionStorage(Database db) {
        this.db = db;
    }
