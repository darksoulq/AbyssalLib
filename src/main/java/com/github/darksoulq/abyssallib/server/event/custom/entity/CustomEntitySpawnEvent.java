...
/**
 * Custom event triggered when a custom {@link CustomEntity} is spawned into the world.
 * <p>
...
public class CustomEntitySpawnEvent extends Event implements Cancellable {
     ...
     */
    public CustomEntitySpawnEvent(@NotNull CustomEntity<? extends LivingEntity> entity, @NotNull SpawnReason reason) {
        this.entity = entity;
        this.reason = reason;
    }
