...
public class TestItems {
    ...
    public static final DeferredObject<Item> MAGIC_WAND = ITEMS.register("magic_wand", (name, id) -> new MagicWand(id));
    public static final DeferredObject<Item> BLOCK_ITEM = ITEMS.register("test_block", (name, id) -> new Item(id, Material.DIRT));
}
